...
{ 
 ...
 public int testBasket_2(int testIdx) {
  ...
  try {
   ...
   System.out.println("myproducts"+myProducts.length+"res "+res);
   
   System.out.println("RESERVATIONS");
   System.out.println(myProducts[0].reservationName());
   System.out.println(myProducts[1].reservationName());
   
   
   if(res == true 
		   && myProducts.length == 2 
		   && myProducts[0].equals(r1) 
		   && myProducts[1].equals(r3)) {
    grade += 6;
   } else {
